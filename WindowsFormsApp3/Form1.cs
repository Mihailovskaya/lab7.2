...

{
	public partial class Form1 : Form
	{
		...
		/// происходит изменение цвета panel1 в зависимости от положения ползунков.
		/// </summary>
		...
		///  изменяется значение color, заносится в буфер обмена, и становится значением для вывода в всплывающем окне
		/// </summary>
